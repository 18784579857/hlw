...
export default {
  ...
  methods: {
    getData () {
      this.$get(allUrl.personalSales + '1/' + this.pages + '/10000').then((res) => {
      // this.$get('http://192.168.5.67:8080/app/user/sales/selectUserSales/' + '1/' + this.pages + '/10').then((res) => {
        if (res.success) {
