      ...
      <el-form class="form" :label-position="labelPosition" :model="formData">
        <ul>
          ...
          <li>
            ...
            <input width="100%" v-model="formData.userName.value" type="text" placeholder="请输入姓名">
          </li>
          <li>
          ...
          <!-- <li>
            <span class="lable_name">银行卡绑定手机号：</span>
            <input width="100%" v-model="formData.bankPhone.value" type="tel" placeholder="请输入手机号">
          </li> -->
          <!-- <li>
          ...
          <li>
            ...
            <input type="text" v-model="formData.realName.value" placeholder="请填写银行卡卡户真实姓名">
          </li> -->
          <!-- <li>
            <span>邮箱：</span>
  ...
  methods: {
    update () {
      ...
      this.$post(allUrl.addAgency, {
        ...
        // bankPhone: formData.bankPhone.value,
        // realName: formData.realName.value
      }).then(function (res) {
        if (res.success) {
          me.$toast({
            message: '添加成功！',
